...
| `104_Figures.do` | What it does | `31` | Same? |
|:--|:--|:--|:--|
...
| | `104` does | the note says | `31` default |
|:--|:--|:--|:--|
...
Decision: open -- Ann-Kristin to confirm the mean grain; then `104` and `31` say the same thing.
